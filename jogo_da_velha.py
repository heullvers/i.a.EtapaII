...
while True:
    ...
    j = '' ##X ou O
    primeiro = '' ##'EU' ou 'PC'
    p1, p2, p3, p4, p5, p6, p7, p8, p9 = ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' ##Guarda X ou O na posição
    lv = 'livre'
    pos1, pos2, pos3, pos4, pos5, pos6, pos7, pos8, pos9 = lv, lv, lv, lv, lv, lv, lv, lv, lv ##Guarda se está 'livre' ou 'ocupada'
    jogada = 0
    jog_adv = 0
    jogada_aleatoria = 0
    turnos = 1
